                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="section-title-wrap text-center section-space--mb_30">
                                ...
                                <p class="title-dec-text">The IT services that Allied Tech are running can be segmented by the type of skills employed to deliver the service (design, build, run). Technically, these fall into three main categories: business process services, application services, and infrastructure services.</p>
                            </div>
                            <!-- section-title-wrap Start -->
                        </div>
                    </div>
                            ...
                            <div class="col-12">
                                <div class="row row--35">
                                    ...
                                    <div class="col-lg-4 col-md-6 mt-30">
                                        ...
                                        <a href="/contact" class="box-large-image__wrap wow move-up">
                                                ...
                                                <div class="box-large-image__midea">
                                                    <div class="images-midea">
                                                        ...
                                                        <div class="heading-wrap">
                                                            <h5 class="heading">Allied Tech Management Systems</h5>
                                                        </div>
